...
const lang = {
    zh: '中文', en: '英语', jp: '日语', fra: '法语', wyw: '文言文', spa: '西班牙语',
    ru: '俄语', it: '意大利语', de: '德语', nl: '荷兰语', pl: '波兰语', dan: '丹麦语',
    cs: '捷克语', swe: '瑞典语', hu: '匈牙利语', vie: '越南语', kor: '韩语', th: '泰语',
    ...
    bel: '白俄罗斯语', sme: '北方萨米语', ped: '北索托语', bem: '本巴语', bli: '比林语', bis: '比斯拉马语',
    bal: '俾路支语', ice: '冰岛语', bos: '波斯尼亚语', bho: '博杰普尔语', chv: '楚瓦什语', tso: '聪加语',
    ...
    cos: '科西嘉语', cre: '克里克语', cri: '克里米亚鞑靼语', kli: '克林贡语', hrv: '克罗地亚语', que: '克丘亚语', kas: '克什米尔语',
    kok: '孔卡尼语', kur: '库尔德语', lat: '拉丁语', lao: '老挝语', rom: '罗马尼亚语', lag: '拉特加莱语', lav: '拉脱维亚语', 
    lim: '林堡语', lin: '林加拉语', lug: '卢干达语', ltz: '卢森堡语', ruy: '卢森尼亚语', kin: '卢旺达语', lit: '立陶宛语', roh: '罗曼什语', 
    ro: '罗姆语', loj: '逻辑语', may: '马来语', bur: '缅甸语', mar: '马拉地语', mac: '马其顿语', mal: '马拉雅拉姆语', mg: '马拉加斯语', 
    mah: '马绍尔语', mai: '迈蒂利语', glv: '曼克斯语', mau: '毛里求斯克里奥尔语', mao: '毛利语', ben: '孟加拉语', mlt: '马耳他语', 
    ...
    srd: '萨丁尼亚语', sm: '萨摩亚语', sec: '塞尔维亚-克罗地亚语', sin: '僧伽罗语', sk: '斯洛伐克语', sol: '桑海语', srp: '塞尔维亚语', 
    nob: '书面挪威语', epo: '世界语', slo: '斯洛文尼亚语', swa: '斯瓦希里语', src: '塞尔维亚语（西里尔）', som: '索马里语', tr: '土耳其语', 
    tgk: '塔吉克语', tam: '泰米尔语', tgl: '他加禄语', tir: '提格利尼亚语', tel: '泰卢固语', tua: '突尼斯阿拉伯语', tuk: '土库曼语', 
    ukr: '乌克兰语', wln: '瓦隆语', wel: '威尔士语', ven: '文达语', wol: '沃洛夫语', urd: '乌尔都语', heb: '希伯来语', el: '希腊语', 
...
const command = {
    ...
    async action(args, commandHandle) {
        ...
        // let to = 'auto';
        // const indexTo = args.findIndex(v => v === '-t');
        // if (indexTo !== -1) {
        //     let v = args[indexTo + 1];
        //     try {
        //         if (!v) {
        ...
        // }
        // let from = 'auto';
        // const indexFrom = args.findIndex(v => v === '-f');
        // if (indexFrom !== -1) {
        //     let v = args[indexFrom + 1];
        //     try {
        //         if (!v) {
        //             throw new Error('参数错误');
        //         }
        ...
        if (data.error_code) {
            ...
            return (
                <div renderkey={new Date().getTime() + data.error_code} className={css.command_txt}>
                    error code：{data.error_code}, code detail see <a href="https://api.fanyi.baidu.com/doc/21">接入文档</a>
                </div>
            )
        }
        else {
